! function (t, e) {
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e))
        ...
        j(k, "displayError", {
            ...
            if (e) throw Error(a);
            S.console && -1 === T.messages.indexOf(a)
        }), T.messages.push(a)
    }
        ...
        td = class {
            ...
            getDateFormat(t, e, i, s) {
                let o = this.dateFormat("%m-%d %H:%M:%S.%L", e),
                    ...
                    h = n;
                for (n in tr) {
                    if (t === tr.week && +this.dateFormat("%w", e) === i && o.substring(6) === r.substring(6)) {
                        n = "week";
                        break
                    }
                    if (tr[n] > t) {
                    ...
                    if (a[n] && o.substring(a[n]) !== r.substring(a[n])) break;
                    "week" !== n && (h = n)
                }
    ...
    class tk {
        ...
        constructor(t) {
            ...
            if ("object" == typeof t && void 0 !== t.stops) this.stops = t.stops.map(t => new tk(t[1]));
                ...
                for (this.input = t = tk.names[t.toLowerCase()] || t, s = tk.parsers.length; s-- && !i;)(e = (o = tk.parsers[s]).regex.exec(t)) && (i = o.parse(e));
            i && (this.rgba = i)
        }
        get(t) {
            let e = this.input,
        ...
        brighten(t) {
            ...
            if (this.stops) this.stops.forEach(function (e) {
                ...
                for (let i = 0; i < 3; i++) e[i] += tb(255 * t), e[i] < 0 && (e[i] = 0), e[i] > 255 && (e[i] = 255);
            return this
        }
        setOpacity(t) {
    ...
    tk.names = {
        ...
        parse: function (t) {
            return [tb(t[1] + t[1], 16), tb(t[2] + t[2], 16), tb(t[3] + t[3], 16), tv(t[4]) ? tb(t[4] + t[4], 16) / 255 : 1]
        }
    }, {
    ...
    let tR = {
        ...
        tq = t_ && tj(t_.createPolicy) && t_.createPolicy("highcharts", {
            createHTML: t => t
        }),
        tZ = tq ? tq.createHTML("") : "";
    class tK {
        static filterUserAttributes(t) {
            return t$(t, (e, i) => {
                let s = !0; - 1 === tK.allowedAttributes.indexOf(i) && (s = !1), -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = tU(e) && tK.allowedReferences.some(t => 0 === e.indexOf(t))), s || (tY(33, !1, void 0, {
    ...
    function ei(t = "", e, i) {
        ...
        return r.forEach(s => {
            ...
            if (m) {
                ...
                for (p = 0; p <= a; p++) {
                    let t = f.charAt(p);
                    h || '"' !== t && "'" !== t ? h === t && (h = "") : h = t, h || " " !== t && p !== a || (o.push(f.substring(n, p - n)), n = p + 1)
                }
    ...
    class eY {
        ...
        attr(t, e, i, s) {
            let {
                element: o
            } = this, r = eY.symbolCustomAttribs, a, n, h = this, l;
        ...
        css(t) {
            ...
            if (e && ez(t, function (t, s) {
                ...
                let a = eN(t);
                s.namespaceURI === this.SVG_NS && (["textOutline", "textOverflow", "whiteSpace", "width"].forEach(t => a && delete a[t]), a.color && (a.fill = a.color)), eS(s, a)
            }
        ...
        getBBox(t, e) {
            ...
            let {
                ...
                cache: c,
                cacheKeys: p
            } = h, g = n.namespaceURI === this.SVG_NS, u = eR(e, this.rotation, 0), f = h.styledMode ? n && eY.prototype.getStyle.call(n, "font-size") : l.fontSize;
            if (eT(d) && (-1 === (r = d.toString()).indexOf("<") && (r = r.replace(/\d/g, "0")), r += ["", h.rootFontSize, f, u, this.textWidth, a, l.lineClamp, l.textOverflow, l.fontWeight].join(",")), r && !t && (i = c[r]), !i || i.polygon) {
                if (g || h.forExport) {
                    try {
        ...
        getRotatedBox(t, e) {
            let {
                ...
                rotationOriginX: h = 0,
                rotationOriginY: l = 0
            } = this, d = eL(a), c = Number(this.element.getAttribute("y") || 0) - (n ? 0 : s), p = e * eu, g = (e - 90) * eu, u = Math.cos(p), f = Math.sin(p), m = o * u, x = o * f, y = Math.cos(g), b = Math.sin(g), [
                [v, k],
                [w, M]
        ...
        shadow(t) {
            let {
                renderer: e
            } = this, i = eN(this.parentGroup ?.rotation === 90 ? {
                offsetX: -1,
                offsetY: -1
        ...
        titleSetter(t) {
            ...
            e.insertBefore ? e.insertBefore(i, e.firstChild) : e.appendChild(i), i.textContent = eX(eR(t, ""), [/<[^>]*>/g, ""]).replace(/&lt;/g, "<").replace(/&gt;/g, ">")
        }
        toFront() {
            let t = this.element;
    ...
    class eJ extends ej {
        ...
        getBBox(t, e) {
            ...
            let {
                ...
                translateY: r = 0,
                width: a = 0
            } = this, n = eZ(this.paddingLeft, i), h = e ?? (this.rotation || 0), l = {
                width: a,
                height: s,
                x: o + this.bBox.x - n,
        ...
        updateBoxSize() {
            ...
            let e = this.text,
                i = {},
                s = this.padding,
                o = this.bBox = (!e_(this.widthSetting) || !e_(this.heightSetting) || this.textAlign) && eU(e.textStr) ? e.getBBox(void 0, 0) : eJ.emptyBBox;
    ...
    function e2(t, e, i, s, o) {
        ...
        if (o) {
            ...
            b.params = {
                ...
                cx: t,
                cy: e
            }, r.push(["M", t + n * u, e + h * f], b), eQ(p) && ((b = ["A", p, p, 0, y, eQ(o.clockwise) ? 1 - o.clockwise : 0, t + p * u, e + p * f]).params = {
                start: c,
                end: a,
                cx: t,
                cy: e
    ...
    let iK = iZ.prototype;
    iK.visibilitySetter = iK.opacitySetter = i_, iK.ySetter = iK.rotationSetter = iK.rotationOriginXSetter = iK.rotationOriginYSetter = iK.xSetter,
        function (t) {
            t.xAxis = {
                alignTicks: !0,
    ...
    let i3 = a,
        ...
        sa = class {
            ...
            addLabel() {
                let t = this,
                    ...
                    g = l.info,
                    u = t.label,
                    f, m, x, y = this.parameters.category || (o ? sr(o[n], a[n], n) : n);
                ...
                let v = t => h.formatter ? h.formatter.call(t, t) : h.format ? (t.text = e.defaultLabelFormatter.call(t), eo.format(h.format, t, s)) : e.defaultLabelFormatter.call(t),
                    k = v.call(b, b),
                    w = m && m.list;
            ...
            getLabelPosition(t, e, i, s, o, r, a, n) {
                ...
                let d = this.axis,
                    ...
                    m = o.distance,
                    x = {};
                return h = 0 === d.side ? i.rotation ? -m : -i.getBBox().height : 2 === d.side ? u.y + m : Math.cos(i.rotation * i5) * (u.y - i.getBBox(!1, 0).height / 2), i4(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y), t = t + sr(o.x, [0, 1, 0, -1][d.side] * m) + f + u.x - (r && s ? r * c * (p ? -1 : 1) : 0), e = e + h - (r && !s ? r * c * (p ? 1 : -1) : 0), g && (l = a / (n || 1) % g, d.opposite && (l = g - l - 1), e += l * (d.labelOffset / g)), x.x = t, x.y = Math.round(e), st(this, "afterGetLabelPosition", {
                    pos: x,
                    tickmarkOffset: r,
                    index: a
                }), x
        ...
        sz = (t, e) => sL(e, void 0, void 0, sE(t.options.allowDecimals, e < .5 || void 0 !== t.tickAmount), !!t.tickAmount);
    sk(sd, {
        xAxis: sh,
        yAxis: sP(sh, sl)
    });
    class sR {
        ...
        adjustForMinRange() {
            ...
            })) || 0), this.dataMax - this.dataMin)), sC(s) && sC(o) && sC(r) && s - o < r && (n = this.dataMax - this.dataMin >= r, a = (r - s + o) / 2, h = [o - a, i.parse(t.min) ?? o - a], n && (h[2] = e ? e.log2lin(this.dataMin) : this.dataMin), l = [(o = sg(h)) + r, i.parse(t.max) ?? o + r], n && (l[2] = e ? e.log2lin(this.dataMax) : this.dataMax), (s = su(l)) - o < r && (h[0] = s - r, h[1] = i.parse(t.min) ?? s - r, o = sg(h))), this.minRange = r, this.min = o, this.max = s
        }
        getClosest() {
            let t, e;
        ...
        setTickInterval(t) {
            let {
                ...
                options: h,
                softThreshold: l
            } = this, d = i.time, c = sC(this.threshold) ? this.threshold : void 0, p = this.minRange || 0, {
                ceiling: g,
                floor: u,
                linkedTo: f,
                softMax: m,
                softMin: x
            } = h, y = sC(f) && i[this.coll] ?. [f], b = h.tickPixelInterval, v = h.maxPadding, k = h.minPadding, w = 0, M, S = sC(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0, T, C, A, P;
        ...
        setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t.tickmarkPlacement && 1 === this.tickInterval ?.5 : 0, this.single = this.min === this.max && sx(this.min) && !this.tickAmount && (this.min % 1 == 0 || !1 !== t.allowDecimals), e) n = e.slice();
                ...
                if (!this.ordinal ?.positions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n = [this.min, this.max], sv(19, !1, this.chart);
                    ...
                    let t = this.tickInterval,
                        e = t;
                    for (; e <= 2 * t;)
                        if (n = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n.length > this.tickAmount) this.tickInterval = sz(this, e *= 1.1);
                        else break
                }
        ...
        tickSize(t) {
            let e = this.options,
                i = sE(e["tick" === t ? "tickWidth" : "minorTickWidth"], "tick" === t && this.isXAxis && !this.categories ? 1 : 0),
        ...
        unsquish() {
            let t = this.options.labels,
                ...
                p;
            if (i) {
                if (!t.staggerLines && (sC(r) ? p = [r] : o < t.autoRotationLimit && (p = t.autoRotation)), p) {
                    let t, e;
        ...
        destroy(t) {
            ...
            if (sw(this, "destroy", {
                keepEvents: t
            }), t || sD(e), [e.ticks, e.minorTicks, e.alternateBands].forEach(function (t) {
                sy(t)
            }), i) {
                let t = i.length;
                for (; t--;) i[t].destroy()
    ...
    ! function (t) {
        ...
        function r(t, e, i) {
            ...
            let s = this.getPlotLinePath({
                ...
                o = [],
                r = this.horiz,
                a = !sq(this.min) || !sq(this.max) || t < this.min && e < this.min || t > this.max && e > this.max,
    ...
    class s4 {
        ...
        render() {
            ...
            let {
                ...
                label: f,
                svgElem: m
            } = this, x = [], y, b = s0(c) && s0(d), v = s0(p), k = !m, w = {
    ...
    class ov {
        ...
        getAnchor(t, e) {
            ...
            if ((t = oy(t))[0].series && t[0].series.yAxis && !t[0].series.yAxis.options.reversedStacks && (t = t.slice().reverse()), this.followPointer && e) void 0 === e.chartX && (e = o.normalize(e)), i = [e.chartX - n, e.chartY - a];
        ...
        getClassName(t, e, i) {
            let s = this.options,
                o = t.series,
                r = o.options;
            return [s.className, "highcharts-label", i && "highcharts-tooltip-header", e ? "highcharts-tooltip-box" : "highcharts-tooltip", !i && "highcharts-color-" + om(t.colorIndex, o.colorIndex), r && r.className].filter(ou).join(" ")
        }
        getLabel({
            anchorX: t,
            anchorY: e
        ...
        refresh(t, e) {
            let {
                ...
                pointer: o,
                shared: r
            } = this, a = oy(t), n = a[0], h = s.format, l = s.formatter || this.defaultFormatter, d = i.styledMode, c = this.allowShared;
        ...
        renderSplit(t, e) {
            let i = this,
                ...
                y = i.outside && "number" != typeof d ? oi.documentElement.getBoundingClientRect() : {
                    left: m,
                    right: m + o,
                    top: x,
                    bottom: x + r
        ...
        updatePosition(t) {
            let {
                ...
                scaleX: c,
                scaleY: p
            } = r.getChartPosition(), g = (o.positioner || this.getPosition).call(this, h, n, t), u = k.doc, f = (t.plotX || 0) + e.plotLeft, m = (t.plotY || 0) + e.plotTop, x;
    ...
    class oX {
        ...
        optionsToObject(t) {
            ...
            if (oD(t) || null === t) r[s[0]] = t;
                ...
                for (!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis ?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]), n++); h < o;) i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? oX.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]), n++, h++;
        ...
        pos(t, e = this.plotY) {
            if (!this.destroyed) {
                ...
                if (oD(i) && oD(e)) return t && (n = r ? r.pos : o.plotLeft, h = a ? a.pos : o.plotTop), o.inverted && r && a ? [a.len - e + h, r.len - i + n] : [i + n, e + h]
            }
        }
        resolveColor() {
            let t = this.series,
    ...
    class o6 {
        ...
        drag(t) {
            ...
            } = e.options.chart, n = e.plotLeft, h = e.plotTop, l = e.plotWidth, d = e.plotHeight, c = oQ(o) ? o.enabled : o, p = r && t[`${r}Key`], g = t.chartX, u = t.chartY, f, m = this.selectionMarker;
        ...
        getHoverData(t, e, i, s, o, r) {
            ...
            oK(this, "beforeGetHoverData", d), l = h && !h.stickyTracking ? [h] : i.filter(t => t.stickyTracking && (d.filter || n)(t));
        ...
        setPointerCapture() {
            ...
            let t = this.pointerCaptureEventsToUnbind,
                e = this.chart,
                i = e.container,
                s = o2(e.options.tooltip ?.followTouchMove, !0) && e.series.some(t => t.options.findNearestPointBy.indexOf("y") > -1);
    ...
    class rG {
        ...
        getProcessedData(t) {
            ...
            return r && (u = (g = r.getExtremes()).min, f = g.max, y = !!(r.categories && !r.names.length), s && e.sorted && !n && (!a || l > a || e.forceCrop) && (m[l - 1] < u || m[0] > f ? x = new re : e.getColumn(e.pointValKey || "y").length && (m[0] < u || m[l - 1] > f) && (x = (d = this.cropData(i, u, f)).modified, p = d.start, c = !0))), m = x.getColumn("x") || [], {
                ...
                cropped: c,
                cropStart: p,
                closestPointRange: rE([h ? m.map(h.log2lin) : m], () => e.requireSorting && !y && rA(15, !1, e.chart))
            }
        }
        processData(t) {
            let e = this.xAxis,
        ...
        animate(t) {
            let {
                ...
                group: i,
                markerGroup: s
            } = this, o = e.inverted, r = rc(this.options.animation), a = [this.getSharedClipKey(), r.duration, r.easing, r.defer].join(","), n = e.sharedClips[a], h = e.sharedClips[a + "m"];
            if (t && i) {
        ...
        drawPoints(t = this.points) {
            ...
            let h = this.chart,
                ...
                u = this.xAxis,
                f = rH(p.enabled, !u || !!u.isRadial || null, this.closestPointRangePx >= p.enabledThreshold * p.radius);
        ...
        pointAttribs(t, e) {
            let i = this.options.marker,
                ...
                h, l, d = this.color,
                c, p, g = rH(o.lineWidth, i.lineWidth),
                u = 1;
        ...
        drawTracker() {
            let t = this,
                ...
                l = "rgba(192,192,192," + (rf ? 1e-4 : .002) + ")",
                d = t.tracker;
            d ? d.attr({
                d: s
        ...
        addPoint(t, e, i, s, o) {
            ...
            d.setRow(f, a, !0, {
                addColumns: !1
            }), p && f.name && (p[m] = f.name), g ?.splice(a, 0, t), (r || this.processedData) && (this.data.splice(a, 0, null), this.processData()), "point" === n.legendType && this.generatePoints(), i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, g, ...Object.values(d.getColumns())].filter(rM).forEach(t => {
                t.shift()
        ...
        removePoint(t, e, i) {
            let s = this,
                ...
                h = r[t],
                l = function () {
                    [a ?.length === r.length ? a : void 0, r, s.options.data, ...Object.values(n.getColumns())].filter(rM).forEach(e => {
                        e.splice(t, 1)
        ...
        setState(t, e) {
            ...
            if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function (e) {
                ...
                if (t && (h = a[t].lineWidth || h + (a[t].lineWidthPlus || 0), l = rH(a[t].opacity, l)), o && !o.dashstyle && rN(h))
    ...
    class ae {
        ...
        adjustMargins(t, e) {
            ...
            o && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (r, a) {
                r.test(o) && !r0(t[a]) && (i[r_[a]] = Math.max(i[r_[a]], i.legend[(a + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a] * s[a % 2 ? "x" : "y"] + r9(s.margin, 12) + e[a] + (i.titleOffset[a] || 0)))
            })
        }
        proximatePositions() {
            let t;
        ...
        render() {
            let t = this.chart,
                ...
                r, a, n, h = this.group,
                l, d = this.box;
            this.itemX = s, this.itemY = this.initialItemY, this.offsetWidth = 0, this.lastItemY = 0, this.widthOption = r8(i.width, t.spacingBox.width - s), l = t.spacingBox.width - 2 * s - i.x, ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) > -1 && (l /= 2), this.maxLegendWidth = this.widthOption || l, h || (this.group = h = e.g("legend").addClass(i.className || "").attr({
                zIndex: 7
    ...
    class aG {
        ...
        redraw(t) {
            ...
            let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [],
                ...
                u;
            for (a.rootFontSize = a.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(!1), ar(!!this.hasRendered && t, this), n && this.temporaryDisplay(), this.layOutTitles(!1), c = i.length; c--;)
        ...
        temporaryDisplay(t) {
            let e = this.renderTo,
                i;
            if (t)
                for (; e && e.style;) e.hcOrigStyle && (ay(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (ad.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode;
            else
                for (; e && e.style && (ad.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, ad.body.appendChild(e)), ("none" === aP(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
        ...
        getContainer() {
            ...
            if (this.renderer = new d(l, h, n, void 0, i.forExport, e.exporting && e.exporting.allowHTML, this.styledMode), ar(void 0, this), this.setClassName(i.className), this.styledMode)
        ...
        update(t, e, i, s) {
            ...
            c && (aD(!0, n.options.chart, c), this.setZoomOptions(), "className" in c && n.setClassName(c.className), ("inverted" in c || "polar" in c || "type" in c) && (n.propFromSeries(), o = !0), "alignTicks" in c && (o = !0), "events" in c && ah(this, c), aB(c, function (t, e) {
                ...
                t[e] && (aH(t[e]).forEach(function (t, s) {
                    let o;
                    let r = ab(t.id);
                    r && (o = n.get(t.id)), !o && n[e] && (o = n[e][aN(t.index, s)]) && (r && ab(o.options.id) || o.options.isInternal) && (o = void 0), o && o.coll === e && (o.update(t, !1), i && (o.touched = !0)), !o && i && n.collectionsWithInit[e] && (n.collectionsWithInit[e][0].apply(n, [t].concat(n.collectionsWithInit[e][1] || []).concat([!1])).touched = !0)
        ...
        transform(t) {
            ...
            for (let t of (this.hoverPoints ?.forEach(t => t.setState()), e)) {
                let {
                    ...
                    options: f,
                    reversed: m
                } = t, x = e ? "width" : "height", y = e ? "x" : "y", b = aN(a[x], t.len), v = aN(s[x], t.len), k = 10 > Math.abs(b) ? 1 : b / v, w = (s[y] || 0) + v / 2 - t.pos, M = w - ((a[y] ?? t.pos) + b / 2 - t.pos) / k, S = m && !h || !m && h ? -1 : 1;
                ...
                let {
                    ...
                    min: O,
                    max: E
                } = aS(t.getExtremes(), A || {}), I = l.parse(f.min), D = l.parse(f.max), B = P ?? I, N = L ?? D, z = C - T, R = t.categories ? 0 : Math.min(z, N - B), W = B - R * (ab(I) ? 0 : f.minPadding), H = N + R * (ab(D) ? 0 : f.maxPadding), X = t.allowZoomOutside || 1 === k || "zoom" !== n && k > 1, F = Math.min(I ?? W, W, X ? O : W), G = Math.max(D ?? H, H, X ? E : H);
    ...
    class a0 {
        ...
        static afterSetSize(t, e) {
            ...
            if (!d.forExport && (r ? (t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth), i && (t.scrollablePlotBox = aZ(t.plotBox), h.width = t.plotWidth += i, n[l ? "height" : "width"] += i, o = !0)) : a && (t.scrollablePixelsY = s = Math.max(0, a - t.chartHeight), a_(s) && (t.scrollablePlotBox = aZ(t.plotBox), h.height = t.plotHeight += s, n[l ? "width" : "height"] += s, o = !1)), a_(o) && !e.skipAxes))
        ...
        constructor(t) {
            ...
            let n = this.parentDiv = a$("div", {
                ...
                h = this.scrollingContainer = a$("div", {
                    className: "highcharts-scrolling"
                }, a, n),
                l = this.innerContainer = a$("div", {
                    className: "highcharts-inner-container"
                }, void 0, h),
                d = this.fixedDiv = a$("div", {
        ...
        moveFixedElements() {
            ...
            let {
                ...
                scrollablePixelsX: s,
                scrollablePixelsY: o
            } = this.chart, r = this.fixedRenderer, a = a0.fixedSelectors;
            if (s && !i ? t = ".highcharts-yaxis" : s && i ? t = ".highcharts-xaxis" : o && !i ? t = ".highcharts-xaxis" : o && i && (t = ".highcharts-yaxis"), t && !(this.chart.hasParallelCoordinates && ".highcharts-yaxis" === t))
                for (let e of [`${t}:not(.highcharts-radial-axis)`, `${t}-labels:not(.highcharts-radial-axis-labels)`]) aK(a, e);
            else
                for (let t of [".highcharts-xaxis", ".highcharts-yaxis"])
                    for (let e of [`${t}:not(.highcharts-radial-axis)`, `${t}-labels:not(.highcharts-radial-axis-labels)`]) aq(a, e);
    ...
    let {
        ...
        getStackBox(t) {
            let e = this.axis,
                ...
                p = Math.abs(l - e.toPixels(n || a9(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0)),
                g = i.inverted,
                u = this.isNegative;
            return g ? {
    ...
    function nl() {
        ...
        this.axes.forEach(t => {
            ...
            e.options.stacking && e.reserveSpace() && (e.stackKey = [e.type, nh(e.options.stack, ""), t ? i.top : i.left, t ? i.height : i.width].join(","))
        })
    }
    ...
    class nI extends nL {
        getPointSpline(t, e, i) {
            ...
            let p = ["C", nE(l.rightContX, l.plotX, 0), nE(l.rightContY, l.plotY, 0), nE(s, n, 0), nE(o, h, 0), n, h];
    ...
    class nJ extends rY {
        ...
        drawTracker(t = this.points) {
            ...
            t.forEach(function (t) {
                e = nV(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : [], t.graphic && (t.graphic.element.point = t), e.forEach(function (e) {
    ...
    ! function (t) {
        ...
        function i(t, e, i, s, o) {
            ...
            } = this, n = this.isCartesian && r.inverted, h = t.plotX, l = t.plotY, d = i.rotation || 0, c = n2(h) && n2(l) && r.isInsidePlot(h, Math.round(l), {
                inverted: n,
                paneCoordinates: !0,
                series: this
        ...
        function n(t, e) {
            ...
            if (n9(t) && !n9(e)) i = t.map(function (t) {
                ...
                if (n9(t) && n9(e))
                    for (s = Math.max(t.length, e.length); s--;) i[s] = n8(t[s], e[s])
            } else i = n8(t, e);
            return i
        }
    ...
    ! function (t) {
        t.getCenter = function () {
            ...
            let g = [hw(r ?. [0], "50%"), hw(r ?. [1], "50%"), hw(l && l < 0 ? void 0 : t.size, "100%"), hw(d && d < 0 ? void 0 : t.innerSize || 0, "0%")];
            for (!e.angular || this instanceof rY || (g[3] = 0), c = 0; c < 4; ++c) p = g[c], h = c < 2 || 2 === c && /%$/.test(p), g[c] = hM(p, [s, o, a, g[2]][c]) + (h ? i : 0);
    ...
    class hX extends rY {
        ...
        translate(t) {
            ...
            for (t || (this.center = t = this.getCenter()), u = 0; u < h; u++) {
                ...
                }, p = Math.cos(c) * t[2] / 2, g = Math.sin(c) * t[2] / 2, f.tooltipPos = [t[0] + .7 * p, t[1] + .7 * g], f.half = c < -Math.PI / 2 || c > Math.PI / 2 ? 1 : 0, f.angle = c
            }
    ...
    function lh() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let {
                options: t,
                yAxis: e
            } = this, i = "percent" === t.stacking, s = h4.plotOptions ?. [this.type] ?.borderRadius, o = ll(t.borderRadius, le(s) ? s : {}), r = e.options.reversed;
